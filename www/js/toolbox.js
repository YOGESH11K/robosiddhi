...
jsonToolbox["contents"][3] = toolbox_standard["contents"][6];
jsonToolbox["contents"][4] = toolbox_arduino["contents"][0];
jsonToolbox["contents"][5] = toolbox_relay["contents"][0];
jsonToolbox["contents"][6] = toolbox_servo["contents"][0];
